...
//	@Query("SELECT new com.app.shwe.dto.Tm30ResponseDTO(vo.order_id, t.period, t.passportBio, t.visaPage, t.contactNumber, s.price, s.duration, vt.visaType) " +
//		       "FROM Tm30 t " +
...
//	@Query("SELECT new com.app.shwe.dto.Tm30ResponseDTO(vo.order_id, vo.main_visa_id, vo.sub_visa_id, t.user_id )FROM tm30 t"
...
//	@Query("SELECT t.period,t.period,t.passportBio,t.visaPage,t.contactNumber FROM Tm30 t WHERE t.user.id = :id")
