...
public interface Report90DayRepository extends JpaRepository<Report90Day, Integer>{
	...
	@Query("SELECT new com.app.shwe.dto.Report90DayTypeResponseDTO(vo.order_id,vs.serviceName, vo.main_visa_id, vo.sub_visa_id, vt.description, svt.price) "
	...
	List<Report90DayTypeResponseDTO> getVisaOrderByOrderId(@Param("orderId") int orderId);
