...
//	
	@Query("SELECT new com.app.shwe.dto.VisaExtensionDTO(v.id,v.syskey,v.visaTypeDescription,v.passportBio, v.visaPage, v.contactNumber,v.user.userName,v.status,v.createdDate) "
	...
	@Query("SELECT new com.app.shwe.dto.VisaExtensionDTO(v.id,v.syskey,v.visaTypeDescription,v.passportBio, v.visaPage, v.contactNumber,v.user.userName,v.status,v.createdDate) "
			+ " FROM VisaExtension v WHERE v.syskey =:sysKey")
	Optional<VisaExtensionDTO> getVisaOrderById(@Param("sysKey") String sysKey);
